...
module flex_counter ( clear, n_rst, clk, count_enable, rollover_val, count_out, 
  ...
  wire   n55, n56, n15, n16, n17, n18, n19, n20, n21, n22, n23, n24, n25, n26,
         n27, n28, n29, n30, n31, n32, n33, n34, n35, n36, n37, n38, n39, n40,
         n41, n42, n43, n44, n45, n46, n47, n48, n49, n50, n51, n52;

  DFFSR \count_out_reg[0]  ( .D(n52), .CLK(clk), .R(n_rst), .S(1'b1), .Q(n56)
         );
  DFFSR \count_out_reg[2]  ( .D(n50), .CLK(clk), .R(n_rst), .S(1'b1), .Q(
        count_out[2]) );
  DFFSR \count_out_reg[1]  ( .D(n51), .CLK(clk), .R(n_rst), .S(1'b1), .Q(n55)
         );
  ...
  NAND2X1 U39 ( .A(n56), .B(n45), .Y(n44) );
  NAND3X1 U40 ( .A(n47), .B(n19), .C(n48), .Y(n45) );
  XNOR2X1 U41 ( .A(rollover_val[2]), .B(count_out[2]), .Y(n48) );
  XNOR2X1 U42 ( .A(n56), .B(n25), .Y(n31) );
  XNOR2X1 U43 ( .A(rollover_val[1]), .B(n55), .Y(n47) );
  NOR2X1 U44 ( .A(clear), .B(count_enable), .Y(n29) );
  BUFX2 U45 ( .A(n55), .Y(count_out[1]) );
  INVX2 U46 ( .A(n20), .Y(count_out[0]) );
endmodule
